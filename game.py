...
"""
                                   H E L L O!
                    I'm Darren from 12/10/17 at about 17:21.
                    Game.py now also normalises input, removing
                    most punctuation and removes ALL spaces. However
                    this does not please the doctest, which has given me 4
                    errors. I will keep this version of game.py on file
                    to showcase the solutions used, and then go about
                    pleasing the doctest. Hopefully my next report will
                    be me informing you of success.
...
def remove_punct(text):
    ...
    text_no_punct= text.translate(remover)
...
def normalise_input(user_input):
    ...
    'help'
    """
    input_with_caps= remove_punct(user_input)
    input_no_space= remove_spaces(input_with_caps)
    #print(input_no_space)

    #print(input_with_caps)
    #print(type(input_with_caps))
    best_input= input_no_space.lower()
    return(best_input)
...
def print_menu(exits):
    ...
    for place in exits:
        #print(exits)
        print_menu_line(place, exit_leads_to(exits, place))

        #print(next(iter(exits))


                    #_menu_line(exits[place], exit_leads_to(rooms[exits[place]]))
    # COMPLETE THIS PART:
...
def menu(exits):
    ...
    while True:
        ...
        best_choice= normalise_input(choice)
        return best_choice
